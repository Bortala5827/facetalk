...
(function () {
  ...
  var DICT = {
    ...
    peerApproved: { zh: '对方已同意你 — 请点「我也同意」完成互选', en: 'They approved you — tap “I Agree Too” to pair', ja: '相手が承認しました。「私も同意」をタップして完了' },
    ...
    voiceSubmitting: { zh: '⏳ 提交中…', en: '⏳ Submitting…', ja: '⏳ 送信中…' },
    voiceRetry: { zh: '🔄 重试提交（不用重录）', en: '🔄 Retry submit (no re-record)', ja: '🔄 再送信（録り直し不要）' },
    ...
    ratedDoneBackHome: { zh: '互评完成，即将返回主页…', en: 'Reviews done — returning to home…', ja: '評価完了、ホームへ戻ります…' },
